...
if(!defined('USER_AGENT'))
    define('USER_AGENT', 'log-php-sdk-v-0.6.1');
...
class Aliyun_Log_Client {
    ...
    /**
     * Get logs from src service with shardid conditions.
     * Unsuccessful opertaion will cause an Aliyun_Log_Exception.
     *
    ...
    /**
     * List Shards from src service with Project and logstore conditions.
     * Unsuccessful opertaion will cause an Aliyun_Log_Exception.
     *
